...
from app.services.queryDB.processing import fetch_processings_from_db
...
class ProcessingExtractor(BaseExtractor):
    def fetch_data(year: int, grape_type: str) -> list[dict]:
        ...
        try:
            ...
            for item in data:
                processing = ProcessingItem(
                    grape_type=item["GrapeType"],
                    category=item["Category"],
                    product=item["Cultivar"],
            ...
            return fetch_processings_from_db(year)
